                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update',$user) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="role" type="text" class="form-control @error('role') is-invalid @enderror" name="role" value="{{ old('role') }}" required autocomplete="role" autofocus>
                                    ...
                                    <option value="3" {{3== $user->role ? 'selected' : ''}}>Staff</option>
                                    <option value="4" {{4 == $user->role ? 'selected' : ''}}>Sysadmin</option>
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="date" class="form-control @error('date_of_birth') is-invalid @enderror" name="date_of_birth" value="{{ old('date_of_birth',$user->date_of_birth) }}" required autocomplete="date_of_birth" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="mobile_no" type="text" class="form-control @error('mobile_no') is-invalid @enderror" name="mobile_no" value="{{ old('mobile_no',$user->mobile_no) }}" required autocomplete="mobile_no" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" value="password" name="password" required autocomplete="new-password">
